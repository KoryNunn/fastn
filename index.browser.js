...
function flatten(t){return Array.isArray(t)?t.reduce(function(t,e){return null==e?t:t.concat(flatten(e))},[]):t}function attachProperties(t,e){for(var n in this)is.property(this[n])&&this[n].attach(t,e)}function onRender(){this.attach(void 0,0);for(var t in this)is.property(this[t])&&this[t].update()}function detachProperties(t){for(var e in this)is.property(this[e])&&this[e].detach(t)}function destroyProperties(){for(var t in this)is.property(this[t])&&this[t].destroy()}function FastnComponent(t,e,n,r){function i(){var t=d();t!==h&&(h=t,a.attach(h),c.emit("attach",h,1))}function o(){c.emit("detach",1)}var s,c=this,a=new e.Model(!1),d=e.binding(".");d._default_binding=!0,c._type=t,c._settings=n||{},c._children=flatten(r||[]),c.attach=function(t,e){return d.attach(t,e),c},c.detach=function(t){return d.detach(t),c},c.scope=function(){return a},c.destroy=function(){return s?void 0:(s=!0,c.removeAllListeners("render").removeAllListeners("attach"),c.emit("destroy"),c.element=null,a.destroy(),d.destroy(),c)},c.destroyed=function(){return s};var h;c.binding=function(t){return arguments.length?(is.binding(t)||(t=e.binding(t)),d&&d!==t&&(t.attach(d._model,d._firm),d.removeListener("change",i)),d=t,d.on("change",i),d.on("detach",o),i(),c):d},c.clone=function(){return e(c._type,c._settings,c._children.filter(function(t){return!t._templated}).map(function(t){return t.clone()}))},c.children=function(){return c._children.slice()},c.on("attach",attachProperties.bind(this)),c.on("render",onRender.bind(this)),c.on("detach",detachProperties.bind(this)),c.once("destroy",destroyProperties.bind(this)),c.binding(d),e.debug&&c.on("render",function(){c.element&&"object"==typeof c.element&&(c.element._component=c)})}var is=require("./is"),EventEmitter=require("events").EventEmitter;FastnComponent.prototype=Object.create(EventEmitter.prototype),FastnComponent.prototype.constructor=FastnComponent,FastnComponent.prototype._fastn_component=!0,module.exports=FastnComponent;
...
var flatten=require("flatten");module.exports=function(n){var t=[];return function(r){if(!arguments.length)return t.join(" ");r||(r=[]),Array.isArray(r)||(r=[r]),r=flatten(r).join(" ").split(" ").filter(function(n){return null!=n&&""!=n});var a=n.className?n.className.split(" "):[];t.map(function(n){if(n){var t=a.indexOf(n);a.splice(t,1)}}),a=a.concat(r),t=r,n.className=a.join(" ")}};
...
"use strict";module.exports=function(){return!0};
...
function updateText(e){this.element&&(this.element.textContent=null==e?"":e)}function autoRender(e){this.element=document.createTextNode(e)}function autoText(e,t){var n=e.base("text");return n.render=autoRender.bind(n,t),n}function textComponent(e,t,n,o){if(n.auto){if(delete n.auto,!t.isBinding(o[0]))return autoText(t,o[0]);n.text=o[0]}var u=t.base(e,n,o);return u.createTextNode=textComponent.createTextNode,u.render=function(){u.element=u.createTextNode(u.text()),u.emit("render")},u.text=t.property(""),u._updateText=updateText.bind(u),u.text.on("update",function(e){u._updateText(e)}),u.on("update",u.text.update),u}textComponent.createTextNode=function(e){return document.createTextNode(e)},module.exports=textComponent;
