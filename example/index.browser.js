...
var fastn=require("./fastn"),app=fastn("div",require("./header")(),require("./userList")(),require("./stats")(),require("./forkBanner")());window.onload=function(){app.render(),document.body.appendChild(app.element)};
},{"./fastn":4,"./forkBanner":5,"./header":6,"./stats":11,"./userList":13}],8:[function(require,module,exports){
